...
IF OBJECT_ID('DataWareHouse.silver.clients', 'U') IS NOT NULL
BEGIN
...
DROP TABLE IF EXISTS DataWareHouse.silver.commandes;
...
DROP TABLE IF EXISTS DataWareHouse.silver.details_commande;

CREATE TABLE silver.details_commande(
